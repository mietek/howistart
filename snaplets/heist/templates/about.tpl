<apply template="base">
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      ...
      <p>If you have suggestions or questions please contact: <a href="mailto:contact@howistart.org">contact@howistart.org</a>. The code for the site and the articles are aboth on <a href="http://www.github.com/howistart">Github</a>.</p>
